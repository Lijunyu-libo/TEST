...
query = { "$and": [{"trade_date":{"$gte":get_day_time(120)}},{"trade_date":{"$lte":get_day_time(0)}}]}
...
'''
# N(5,10,20,30)日均线值 5日均线连续T日持续下跌  10，20，30日均线拟合
w=0.02
m=1
for row in df_ma.iterrows():
    #5日线连续4日下跌，10，20连续4日纠缠
    if (row[1]['ma5'][0]<row[1]['ma5'][1] and row[1]['ma5'][1]<row[1]['ma5'][2] and row[1]['ma5'][2]<row[1]['ma5'][3] and math.fabs(row[1]['ma10'][0]-row[1]['ma20'][0])/row[1]['ma20'][0] <w):
